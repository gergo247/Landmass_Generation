        ...
        for (int yOffset = -chunksVisibleInViewDst; yOffset <= chunksVisibleInViewDst; yOffset++)
        {
            for (int xOffset = -chunksVisibleInViewDst; xOffset <= chunksVisibleInViewDst; xOffset++)
            {
                ...
                if (terrianChunkDictionary.ContainsKey(viewedChunkCoord))
                {
                    ...
                    {
                        terrainChunksVisibleLastUpdate.Add(terrianChunkDictionary[viewedChunkCoord]);
                    }
                } else {
                    terrianChunkDictionary.Add(viewedChunkCoord, new TerrainChunk(viewedChunkCoord,chunkSize,transform,mapMaterial));
                }
            }
        }
    }
